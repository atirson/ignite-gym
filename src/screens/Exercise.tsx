...
export const Exercise = () => {
  ...
  const [exercise, setExercise] = useState<ExerciceDTO>({} as ExerciceDTO);
  ...
  const fetchExerciseDetails = async () => {
    try {
      ...
      const title = isAppError ? error.message : 'Não foi possível carregar os detalhes do exercícios. Tente novamente mais tarde.';
